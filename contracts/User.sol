...
*/
    function deposit(uint8 coinType, address token, uint256 value) external nonReentrant payable {
...
*/
    function withdraw(uint8 coinType, address token, uint256 value) external nonReentrant {
        require(coinType == 0 || coinType == 1, "invalid coin type!");
        require(value > 0, "invalid value!");
